...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .container { max-width: 1280px; margin: 0 auto; padding: 8px 20px; }
    header {
      position: sticky; top: 0; z-index: 40;
      background: linear-gradient(to bottom, rgba(0,0,0,.45), rgba(0,0,0,0));
      backdrop-filter: blur(6px);
    }
    .nav { display:flex; gap:12px; align-items:center; padding:10px 20px; border-bottom:1px solid var(--border); background: rgba(0,0,0,0.25); }
